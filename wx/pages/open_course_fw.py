...
class OpenCourseFw(Base):
    ...
    # loc_8 = ("xpath",".//*[@class='ant-cascader-menu-item ant-cascader-menu-item-expand']")
    loc_9 = ("id","course")
    ...
    def course_xc(self,c):
        ...
        # self.clicks(self.loc_8,a)
        # ele= self.findElementsNew(self.loc_8)
        # ele[1].click()
        self.click(self.loc_9)
        self.click(self.loc_10)
        # if b in(1,2,3,4):
        #     self.clicks(self.loc_10,b)
        # else:
        #     print("请输入正确的查询参数")
